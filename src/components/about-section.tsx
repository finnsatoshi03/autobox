...
const AnimatedAboutSection = () => {
  ...
  useEffect(() => {
    ...
    tl.to(section, {
      onStart: () => section.classList.add("animate-content"),
      onReverseComplete: () => section.classList.remove("animate-content"),
    });
        ...
        <div ref={headerRef} className="overflow-hidden">
          <h2 className="text-[min(12vw,6rem)] uppercase leading-none md:text-[clamp(1.5rem,6vw,8rem)]">
            <motion.span
              ...
              initial="hidden"
              animate={
                sectionRef.current?.classList.contains("animate-content")
                  ? "visible"
                  : "hidden"
              }
